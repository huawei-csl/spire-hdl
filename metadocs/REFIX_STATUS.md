...
| Differential harness in `testing/differential/` | I2 §1, harness from issues2_repros | pending | evaluator + leaf calibration + nested battery + seeded fuzz |
| Baseline run recorded; §1 bug shapes as strict xfails | — | pending | flipped green by Phase 1 |
