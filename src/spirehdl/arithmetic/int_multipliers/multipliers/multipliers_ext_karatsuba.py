...
class KaratsubaMultiplier(StageBasedMultiplierBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from spirehdl.arithmetic.int_multipliers.eval.multiplier_stage_options_demo_lib import ConfigItem, FSAOption, TwoInputAritEncodings, MultiplierOption, PPAOption, PPGOption
    ...
    def _build_karatsuba(self, a_sig, b_sig, width: int, level=0) -> Expr:
        ...
        if not self.use_compressor:
            ...
            #                         ]
            from spirehdl.arithmetic.int_multipliers.eval.multiplier_stage_options_demo_lib import FSAOption, PPAOption
