...
This module provides a drop-in replacement for :class:`spirehdl.spirehdl_simulator.Simulator`
...
from spirehdl.spirehdl import Expr, Signal
from spirehdl.spirehdl_module import Module
from spirehdl.spirehdl_simulator_base import SimulatorBase
from spirehdl.spirehdl_simulator import Simulator as PythonSimulator

if TYPE_CHECKING:
    from spirehdl.arithmetic.int_multipliers.eval.testvector_generation import TestVectors
...
class TestbenchGenSimulator(SimulatorBase):
    ...
    The public API mirrors :class:`~spirehdl.spirehdl_simulator.Simulator`.  The methods
