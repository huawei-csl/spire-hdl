"""``spirehdl.optimize.fsm`` — FSM minimisation + state-encoding-search utilities.
...
reuse and future decorators::
    ...
    from spirehdl.optimize.fsm import (
...
Conventional import path is ``from spirehdl.spirehdl_state import ...`` — ``spirehdl_state.py`` re-exports the same
