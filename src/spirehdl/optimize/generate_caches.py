...
Usage:
    ...
    python -m spirehdl.optimize.generate_caches --experiment exp_... --from-cache .spirehdl_cache

    # All runs
    python -m spirehdl.optimize.generate_caches --experiment exp_... --from-cache .spirehdl_cache --all

    # Parallel
    python -m spirehdl.optimize.generate_caches --experiment exp_... --from-cache .spirehdl_cache --all --workers 10
"""
...
from spirehdl.spirehdl import HDLType
from spirehdl.optimize.pareto import (
...
def main():
    ...
    parser.add_argument("--from-cache", default=None,
                        help="Path to existing .spirehdl_cache dir to auto-detect base key")
    parser.add_argument("--cache-dir", default=None,
                        help="Output cache directory (default: .spirehdl_cache)")
    ...
    cache_dir = Path(args.cache_dir) if args.cache_dir else Path(".spirehdl_cache")
