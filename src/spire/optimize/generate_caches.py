...
Usage:
    ...
    python -m spire.optimize.generate_caches --experiment exp_... --from-cache .spire_cache

    # All runs
    python -m spire.optimize.generate_caches --experiment exp_... --from-cache .spire_cache --all

    # Parallel
    python -m spire.optimize.generate_caches --experiment exp_... --from-cache .spire_cache --all --workers 10
"""
...
from spire.optimize.pareto import (
...
def main():
    ...
    parser.add_argument("--from-cache", default=None,
                        help="Path to existing .spire_cache dir to auto-detect base key")
    parser.add_argument("--cache-dir", default=None,
                        help="Output cache directory (default: .spire_cache)")
    ...
    cache_dir = Path(args.cache_dir) if args.cache_dir else Path(".spire_cache")
