...
through the verification gate; consumers pick deterministically — most ergonomically via the
...
from spire.design_db.decorator import SELECTION_LOG_ENV, from_design_db  # noqa: F401
...
from spire.design_db.select import (SelectionResult, constrained, lexicographic,  # noqa: F401
                                    metric_value, pareto_front, resolve_metric, pick_design,
                                    weighted)
