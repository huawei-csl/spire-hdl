"""Readers never create: pick_design / pareto_front on a missing DB touch nothing."""
from spire.design_db import pareto_front, pick_design
...
def test_select_readers_never_create_a_db(tmp_path, monkeypatch):
    ...
    assert pick_design("0" * 64, objective="area") is None
