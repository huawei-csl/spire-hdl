"""Regression tests for the AIGER barrel shifter (``sprouthdl_aiger``).
...
from sprouthdl.sprouthdl_aiger import _AIG, lit_const0
from sprouthdl.sprouthdl import UInt, Const, cat, reset_shared_cache
